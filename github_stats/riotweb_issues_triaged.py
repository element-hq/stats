...
untriaged = stats.small_query(query='repo:vector-im/riot-web is:issue is:open -label:p1 -label:p2 -label:p3 -label:p4 -label:p5 -label:maintenance -label:bug -label:feature -label:support -label:wontfix')
